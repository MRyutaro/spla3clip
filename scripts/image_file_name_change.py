...
# 画像データのパス
image_dir = r"C:\Users\recod\programs\splatoon3_highlight_collector\models_build\data\raw\image\kill"
...
for i, image_name in enumerate(os.listdir(image_dir)):
    ...
    os.rename(image_path, os.path.join(image_dir, f"sample_kill_image{i}.png"))
