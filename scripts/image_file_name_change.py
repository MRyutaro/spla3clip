...
# 画像データのパス
image_dir = r"C:\Users\recod\programs\splatoon3_highlight_collector\models_build\data\raw\image\start"
...
for i, image_name in enumerate(os.listdir(image_dir)):
    ...
    os.rename(image_path, os.path.join(image_dir, f"sample_start_image{i}.png"))
    print(f"{image_name}をsample_start_image{i}.pngにリネームしました")
